...
def process_sounds():
    ...
    for category_name, json_string in SOUND_DATA.items():
        ...
        try:
            ...
            # Replace single backslashes with forward slashes for a valid URL path
            ...
            category_clip_dir = os.path.join(OUTPUT_DIR_CLIPS, category_name)
            os.makedirs(category_clip_dir, exist_ok=True)
            
            print(f"  - Extracting clips into: {category_clip_dir}/")
            ...
            for clip_name, timings in data['sprite'].items():
                ...
                clip_path = os.path.join(category_clip_dir, clip_filename)
